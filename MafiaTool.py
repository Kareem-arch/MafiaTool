...
print ("\033[1;31m        /)  \033[1;33m (   \033[1;31m @ \033[1;33m   \ \033[1;31m   ,-.         @\033[1;33>")
...
system('sleep 0.1')
print( y +"["+ g +"3"+ w +"]" + w + "["+g+"----" +r+"Hack facebook" +y+"]" )
system('sleep 0.1')
print( y +"["+ g +"4"+ w +"]" + w + "["+g+"----" +r+"Hack WhatsApp" +y+"]" )
system('sleep 0.1')
print( y +"["+ g +"5"+ w +"]" + w + "["+g+"----" +r+"my facebook" +y+"]" )
system('sleep 0.1')
print( y +"["+ g +"6"+ w +"]" + w + "["+g+"----" +r+"about" +y+"]" )
